...
public class ComputeTax {
    public static void main(String[] args) {
        ...
        System.out.print("(0-single filer,1-married joinly or " +" qualifying widow(er), 2-married separately, 3-head of " + "household) Enter the filing status: ");
        ...
        if(status==0)
        {
            ...
            else if(income<=37250) tax = 8350 *0.10 + ( 33950 - 8350 ) * 0.15 + ( 82250 - 33950 ) * 0.25 + ( 171550 - 82250 ) *0.28 + ( income - 171550 ) *0.33;
